...
public class KarateCompetitor {
    ...
    public int[] getScores() { //Returns a clone of the competitor's scores array.
        return scores.clone();
    }
    ...
    private String calculateLevel() {
        double overallScore = getOverallScore(); // Use the overallScore method to calculate the level
    ...
    public static void insertCompetitor(KarateCompetitor competitor) {
        ...
        try (Connection connection = connectToDatabase();
            ...
            if (e.getSQLState().equals("23000")) {  // SQLState for integrity constraint violation (e.g., duplicate key)
                System.out.println("Error: Duplicate competitor ID."+competitor.getCompetitorID()+" The competitor already exists in the database.");
            } else {
                System.out.println("Error inserting competitor: " + e.getMessage());
            }
        }
    }
